...
import org.compiere.model.I_AM_ServiceOrder;
import org.compiere.model.I_AM_ServiceOrder_Request;
...
//		Locked
		 ...
		 * Maintenance
		 *****************/
		else if (AD_Table_ID == I_AM_ServiceOrder.Table_ID)
		{
			if (docStatus.equals(DocumentEngine.STATUS_Drafted))
			{
				options[0] = DocumentEngine.ACTION_Prepare;
				options[1] = DocumentEngine.ACTION_Close;
			}
			else if (docStatus.equals(DocumentEngine.STATUS_InProgress))
			{
				options[0] = DocumentEngine.ACTION_Complete;
				options[1] = DocumentEngine.ACTION_Close;
			}
			else if (docStatus.equals(DocumentEngine.STATUS_Completed))
			{
				options[0] = DocumentEngine.ACTION_Close;
				options[1] = DocumentEngine.ACTION_Close;
			}
		}
		else if (AD_Table_ID == I_AM_ServiceOrder_Request.Table_ID)
		{
			if (docStatus.equals(DocumentEngine.STATUS_Drafted))
			{
				options[0] = DocumentEngine.ACTION_Prepare;
