...
/** Generated Model for AM_MaintPattern_Resource
 *  @author Adempiere (generated) 
 *  @version 1.4.0 - $Id$ */
public class X_AM_MaintPattern_Resource extends PO implements I_AM_MaintPattern_Resource, I_Persistent 
{
    ...
    public X_AM_MaintPattern_Resource (Properties ctx, int AM_MaintPattern_Resource_ID, String trxName)
    {
      super (ctx, AM_MaintPattern_Resource_ID, trxName);
      /** if (AM_MaintPattern_Resource_ID == 0)
        {
			setAM_MaintenancePattern_Task_ID (0);
			setAM_MaintPattern_Resource_ID (0);
        } */
    }

    /** Load Constructor */
    public X_AM_MaintPattern_Resource (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_AM_MaintPattern_Resource[")
        .append(get_ID()).append("]");
      return sb.toString();
    }

	public I_AM_MaintenancePattern_Task getAM_MaintenancePattern_Task() throws RuntimeException
    {
		return (I_AM_MaintenancePattern_Task)MTable.get(getCtx(), I_AM_MaintenancePattern_Task.Table_Name)
	...
	/** Set AM Maintenance Pattern Resource.
		@param AM_MaintPattern_Resource_ID AM Maintenance Pattern Resource	  */
	public void setAM_MaintPattern_Resource_ID (int AM_MaintPattern_Resource_ID)
	{
		if (AM_MaintPattern_Resource_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_AM_MaintPattern_Resource_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_AM_MaintPattern_Resource_ID, Integer.valueOf(AM_MaintPattern_Resource_ID));
	}

	/** Get AM Maintenance Pattern Resource.
		@return AM Maintenance Pattern Resource	  */
	public int getAM_MaintPattern_Resource_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_AM_MaintPattern_Resource_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
