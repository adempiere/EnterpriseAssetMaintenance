...
public class X_AM_Maintenance extends PO implements I_AM_Maintenance, I_Persistent 
{
	...
	public I_AM_Maintenance getAM_MaintenanceParent() throws RuntimeException
    {
	...
	public I_AM_Meter getAM_Meter() throws RuntimeException
    {
		return (I_AM_Meter)MTable.get(getCtx(), I_AM_Meter.Table_Name)
