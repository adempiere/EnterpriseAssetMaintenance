...
import org.eam.model.MAMPatternTask;
 ...
 */
public class CalculateCostsMaintenancePattern extends CalculateCostsMaintenancePatternAbstract {

	@Override
	protected String doIt() {
		MAMPattern pattern = MAMPattern.get(getCtx(), getRecord_ID());
		for (MAMPatternTask task : pattern.getTasks()) {
			task.updateTaskCosts();
		}
