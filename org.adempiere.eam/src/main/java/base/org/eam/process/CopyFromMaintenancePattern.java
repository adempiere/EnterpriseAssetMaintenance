 ...
 */
public class CopyFromMaintenancePattern extends CopyFromMaintenancePatternAbstract {
	
	/**
	 * Calling helper method for create maintenance task from pattern
	 */
	protected String doIt() throws Exception {
		//	Pattern
		MAMMaintenance maintenance = new MAMMaintenance(getCtx(), getRecord_ID(), get_TrxName());
		if(maintenance.createFromPattern(getPatternId())) {
			return "@Copied@";
		}
		//	
		return "@Ok@";
