...
public class X_AM_ServiceRequest extends PO implements I_AM_ServiceRequest, I_Persistent 
{
    ...
    {
      super (ctx, AM_ServiceRequest_ID, trxName);
      /** if (AM_ServiceRequest_ID == 0)
        {
			setA_Asset_ID (0);
			setAM_RequestType_ID (0);
			setAM_ServiceRequest_ID (0);
			setC_Currency_ID (0);
// 100
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_AM_ServiceRequest (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_AM_ServiceRequest[")
	...
	public void setAM_RequestType_ID (int AM_RequestType_ID)
	{
		if (AM_RequestType_ID < 1) 
			set_Value (COLUMNNAME_AM_RequestType_ID, null);
		else 
	...
	public void setAM_ServiceRequest_ID (int AM_ServiceRequest_ID)
	{
		if (AM_ServiceRequest_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_AM_ServiceRequest_ID, null);
		else 
