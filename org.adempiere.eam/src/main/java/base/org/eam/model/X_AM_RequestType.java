...
public class X_AM_RequestType extends PO implements I_AM_RequestType, I_Persistent 
{
    ...
    {
      super (ctx, AM_RequestType_ID, trxName);
      /** if (AM_RequestType_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_AM_RequestType (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_AM_RequestType[")
	...
	public void setAM_RequestType_ID (int AM_RequestType_ID)
	{
		if (AM_RequestType_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_AM_RequestType_ID, null);
		else 
